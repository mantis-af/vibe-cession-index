  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 pb-24">
        ...
        {/* Metro Hero */}
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 sm:mb-16">
          {/* Background glow */}
          ...
          <div className="relative flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            {/* Score display */}
            <div className="flex items-end gap-6 sm:gap-8 mt-4 md:mt-0">
              <div className="text-left md:text-right">
                ...
                <div className="relative">
                  ...
                  <div className="relative text-5xl sm:text-6xl font-mono font-black tabular-nums" style={{ color }}>
                    {metro.currentScore}
                  </div>
                </div>
